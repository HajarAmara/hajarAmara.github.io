	...
	<div class="super_container_inner">
		...
		<br><br>
			<div class="jumbotron text-center">
			  <h1 class="display-3">תודה רבה שבחרת לקנות אצלנו</h1>
			  <p class="lead"><strong style="color: #2fce98;"> נשלחה הודעה למוכרת בנוגע הזמנתך, חכה לה שתייצר איתך קשר  </strong> </p>
			  <hr>
			  <p >
			    לכל שאלה <a style="color: #2fce98;" href="Contact.jsp">צור קשר איתנו </a>
			  </p>
			  <p class="lead">
			    <a class="btn btn-sm" href="index.jsp" role="button" style="font-size: 24px; ">המשך לדף ראשי</a>
			  </p>
			</div>
		</div>
