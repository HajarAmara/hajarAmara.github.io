...
<%@ page import=" java.io.UnsupportedEncodingException,com.hajar.zaki.dao.UserDAO, com.hajar.zaki.dao.UserDAOImpl,
				 ...
				 java.io.*, java.util.Base64 , com.hajar.zaki.model.Order ,  com.hajar.zaki.dao.OrderDAO,com.hajar.zaki.dao.ProductCustomerDAO,com.hajar.zaki.model.ProductCustomer" %>
...
<div class="menu">
	...
	<div class="menu_nav">
		<ul>
					...
					<li class="active" ><a href="mainCourse.jsp?userName=<%=userName%>&email=<%=email%>"  >מנה עיקרית</a></li>
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">מנה עיקרית</div>
		...
		<div class="products">
			<div class="container">
				...
				<% if(email != null && sup){ %>
					...
					ArrayList<Product> main_sup= prodDao.getAllMain_SUP(email);
					int valuesLength= main_sup.size()-1;
				    InputStream sImage;
					int index_Prod=0;
				    for(index_Prod=0; index_Prod<=valuesLength;index_Prod++){
					  PicturesDao picDao= new PicturesDao();
					  ProductPicture prodPic = picDao.getPicturePerProductId( main_sup.get(index_Prod).getProdID());
					  String imageBase64="";
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.jsp?value=<%=main_sup.get(index_Prod).getProdID()%>">
											 <% 
										        out.println(main_sup.get(index_Prod).getName() ); %> </a></div>
											<div class="product_category">המחיר / السعر  </div>
										</div>
									</div>
									<div class="ml-auto text-right">
										<!-- div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div-->
										<div class="product_price text-right">₪<%out.println(main_sup.get(index_Prod).getPiece_price() ); %> </div>
									</div>
								</div>
				...
				<% }else{ if(email != null && !sup){ 
				%>
				<div class="row products_row ">
					 <% 
					ProductDAO prodDao=new ProductDAO();
					ArrayList<Product> mainCourses= prodDao.getAllMainCourses();
					int valuesLength= mainCourses.size()-1;
				    InputStream sImage;
					int index_Prod=0;
				    for(index_Prod=0; index_Prod<=valuesLength;index_Prod++){
					  PicturesDao picDao= new PicturesDao();
					  ProductPicture prodPic = picDao.getPicturePerProductId( mainCourses.get(index_Prod).getProdID());
					  String imageBase64="";
					  if(prodPic != null && prodPic.getImg()!= null){
						  System.out.print("test into index img " + imageBase64);
						  imageBase64 = new String(Base64.getEncoder().encode((prodPic.getImg())));
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											...
											<div class="product_name"><a href="product.jsp?value=<%=mainCourses.get(index_Prod).getProdID()%>"> <% 
										     out.println(mainCourses.get(index_Prod).getName() ); %> </a></div>
											<div class="product_category">המחיר / السعر  </div>
										</div>
									</div>
									<div class="ml-auto text-right">
										<!-- div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div-->
										<div class="product_price text-right">₪<%out.println(mainCourses.get(index_Prod).getPiece_price() ); %> </div>
									</div>
								</div>
									<%  if( mainCourses.get(index_Prod) != null){
								      ProductCustomerDAO pcdao = new ProductCustomerDAO(); 
									  ProductCustomer pc = new ProductCustomer(); 
									  pc = pcdao.getProductLike(mainCourses.get(index_Prod).getProdID(),email);
								...
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">			
										...
										<div><div>
										 <a  href="product.jsp?value=<%=mainCourses.get(index_Prod).getProdID() %>" style="font-size:32px;border:none; background-repeat:no-repeat;background: transparent; ">  
								...
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">	
						                ...
						                <input type="hidden" value="<%=  mainCourses.get(index_Prod).getProdID()%>" name="prod_id">
										<input type="hidden" value=<%= jspName %> name="jspPage" >	
									    <a href="product.jsp?value=<%=mainCourses.get(index_Prod).getProdID()%>"  
										...
										<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
											<div><div>
											      <form action="<%=request.getContextPath()%>/LikeProductServlet" method="post">
											        <input type="hidden" value="<%= email %>" name="mailCus">
						                            <input type="hidden" value="<%= mainCourses.get(index_Prod).getProdID()%>" name="prodidLiked">
						                            <input type="hidden" value=<%= jspName %> name="jspPage" >											         
				...
				%>
				  ...
				  <div class="row products_row ">
					...
					<% 
					ProductDAO prodDao=new ProductDAO();
					ArrayList<Product> mains= prodDao.getAllMainCourses();
					int valuesLength=mains.size()-1;
				    InputStream sImage;
					int index_Prod=0;
				    for(index_Prod=0; index_Prod<=valuesLength;index_Prod++){
					  PicturesDao picDao= new PicturesDao();
					  ProductPicture prodPic = picDao.getPicturePerProductId(mains.get(index_Prod).getProdID());
					  String imageBase64="";
					  if(prodPic != null && prodPic.getImg()!= null){
						  System.out.print("test into index img " + imageBase64);
						  imageBase64 = new String(Base64.getEncoder().encode((prodPic.getImg())));
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.jsp?value=<%=mains.get(index_Prod).getProdID()%>">
											 <% 
										        out.println(mains.get(index_Prod).getName() ); %> </a></div>
											<div class="product_category">המחיר / السعر  </div>
										</div>
									</div>
									<div class="ml-auto text-right">
										<!-- div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div-->
										<div class="product_price text-right">₪<%out.println(mains.get(index_Prod).getPiece_price() ); %> </div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">										
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_about">
								<div class="footer_logo">
									 <form action="<%=request.getContextPath()%>LIServlet"><a href="index.jsp">
										<div class="d-flex flex-row align-items-center justify-content-start">
